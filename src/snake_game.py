...
###
    def play_step(self, action):
        ...
        reward = 0
        game_over = False
        # if the snake dies or doesn't find the food for too long
        # 100 * len(self.snake) -> the longer the snake, the more time it has
...
#------------------------------------------------------------------------------#        
    def _move(self, action):
        ...
        if numpy.array_equal(action, [1, 0, 0]):
            ...
            new_direction = clock_wise[index] # right turn r -> d -> l -> u
        else: # [0, 0, 1]
            next_index = (index - 1) % 4
